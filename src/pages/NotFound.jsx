...
export default function NotFoundPage() {
  return (
    <div className="w-full h-screen bg-gradient-to-br from-emerald-50 via-white to-green-50 overflow-x-hidden flex justify-center items-center relative">
      <MessageDisplay />
      <CharactersAnimation />
      <CircleAnimation />
    </div>
...
function MessageDisplay() {
  ...
  return (
    <div className="absolute flex flex-col justify-center items-center w-[90%] h-[90%] z-[100]">
      ...
      >
        <div className="text-[35px] font-semibold text-emerald-900 m-[1%]">
          Página No Encontrada
        </div>
        <div className="text-[80px] font-bold text-emerald-600 m-[1%]">
          404
        </div>
        <div className="text-[15px] w-1/2 min-w-[40%] text-center text-gray-700 m-[1%]">
          La página que buscas podría haber sido eliminada, su nombre cambió o está temporalmente no disponible.
        </div>
        <div className="flex gap-6 mt-8">
          <button
            onClick={() => navigate(-1)}
            className="text-emerald-600 border-2 border-emerald-600 hover:bg-emerald-600 hover:text-white transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105 rounded-xl"
          >
            <svg
          ...
          <button
            ...
            className="bg-gradient-to-r from-emerald-600 to-green-600 text-white hover:from-emerald-700 hover:to-green-700 transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105 rounded-xl shadow-lg"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
...
function CharactersAnimation() {
  ...
  useEffect(() => {
    ...
    stickFigures.forEach((figure, index) => {
      ...
      stick.style.filter = 'invert(35%) sepia(89%) saturate(527%) hue-rotate(116deg) brightness(95%) contrast(92%)';
